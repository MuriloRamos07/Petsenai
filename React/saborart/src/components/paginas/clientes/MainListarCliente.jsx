        ...
        <>
            <main className="col-md-9 ms-sm-auto col-lg-10 px-md-4 yr-color-fundo">
                <div className="pv-cores-listar mt-5">
                    <div>
                        <span className="d-block fs-4 ms-4 mt-1">Listar:</span>
                        <span className="d-block fs-6 ms-4 mt-1">Lista de clientes</span>
                    </div>
                    <div className="table-responsive ">
                        <table className="pv-table table-bordered ">
                            ...
                            <tbody className="pv-lista table-hover">
                                {
