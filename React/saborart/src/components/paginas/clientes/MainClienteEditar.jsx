...
function MainClienteEditar() {
    ...
    useEffect( () => {
        async function getDadosAluno(){
           ...
           console.log(dadosAluno);
           setNome(dadosAluno.name);
           setSobrenome(dadosAluno.username);
           setEmail(dadosAluno.email);
           setRua(dadosAluno.address.street);
           setCidade(dadosAluno.address.city);
           setEstado(dadosAluno.address.suite);
           setTelefone(dadosAluno.phone);
        ...
        <>
            <main className="col-md-9 ms-sm-auto col-lg-10 px-md-4 yr-color-fundo">
                <div className="w-auto h-auto yr-cor-fundo-cadastro mt-5">
                    <div className="mt-4">
                        <span className="fs-6 yr-font-arimo-regular d-block ms-4 ">Editar Clientes:</span>
                        <span className="fs-6 d-block yr-font-arimo-regular yr-cor-subtitulo-clientes ms-4">Preencha com os novos dados do cliente</span>
                    </div>
...
export default MainClienteEditar;