...
function MainFuncionarioCadastro() {
        ...
        <>
            <main className="col-md-9 ms-sm-auto col-lg-10 px-md-4 yr-color-fundo">
                <div className="w-auto h-auto yr-cor-fundo-cadastrar-funcionarios mt-5">
                    <div className="mt-4">
                        <span className="fs-6 yr-font-arimo-regular d-block ms-4 ">Cadastro Funcionários:</span>
                        <span className="fs-6 d-block yr-font-arimo-regular yr-cor-subtitulo-clientes ms-4">Preencha com os dados do funcionário</span>
                    </div>
...
export default MainFuncionarioCadastro;